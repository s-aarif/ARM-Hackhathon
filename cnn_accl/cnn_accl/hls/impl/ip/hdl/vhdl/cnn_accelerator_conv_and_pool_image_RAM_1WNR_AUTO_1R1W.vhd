...
entity cnn_accelerator_conv_and_pool_image_RAM_1WNR_AUTO_1R1W is 
    generic(
...
architecture rtl of cnn_accelerator_conv_and_pool_image_RAM_1WNR_AUTO_1R1W is 
...
p_memory_access_r_9: process (clk)  
begin 
    if (clk'event and clk = '1') then
        if (ce9 = '1') then 
...
p_memory_access_r_10: process (clk)  
begin 
    if (clk'event and clk = '1') then
        if (ce10 = '1') then 
...
p_memory_access_r_11: process (clk)  
begin 
    if (clk'event and clk = '1') then
        if (ce11 = '1') then 
...
p_memory_access_r_12: process (clk)  
begin 
    if (clk'event and clk = '1') then
        if (ce12 = '1') then 
...
p_memory_access_w_8: process (clk)  
begin 
    if (clk'event and clk = '1') then
        if (ce0 = '1') then 
...
p_memory_access_w_9: process (clk)  
begin 
    if (clk'event and clk = '1') then
        if (ce0 = '1') then 
...
p_memory_access_w_10: process (clk)  
begin 
    if (clk'event and clk = '1') then
        if (ce0 = '1') then 
...
p_memory_access_w_11: process (clk)  
begin 
    if (clk'event and clk = '1') then
        if (ce0 = '1') then 
