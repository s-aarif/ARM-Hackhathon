...
entity cnn_accelerator_fifo_w32_d2_S is 
    generic (
...
architecture rtl of cnn_accelerator_fifo_w32_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component cnn_accelerator_fifo_w32_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_cnn_accelerator_fifo_w32_d2_S_ShiftReg : cnn_accelerator_fifo_w32_d2_S_ShiftReg
    generic map (
...
entity cnn_accelerator_fifo_w32_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end cnn_accelerator_fifo_w32_d2_S_ShiftReg;

architecture rtl of cnn_accelerator_fifo_w32_d2_S_ShiftReg is
